...
export default function SectorGroup({
  ...
  return (
    <div className="border-b border-gray-200">
      ...
      <button
        onClick={onToggle}
        className="flex w-full items-center gap-1 border-b border-gray-200 bg-gray-100 px-2 py-2 text-left text-xs font-semibold text-gray-700 transition-colors hover:bg-gray-200 md:gap-2 md:px-4 md:py-3 md:text-sm"
      >
        <div
